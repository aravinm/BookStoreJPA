...
<h2><%= book.getTitle() %>
</h2>&nbsp; by<em><%= book.getFirstName() + " " + book.getSurname() %>
</em> (<%= book.getCalendarYear() %>)<br> <br>
<h4>Here's what the critcs say: </h4>
<blockquote><%= book.getDescription() %>
</blockquote>
<h4>Our Price: <%= book.getPrice() %>
</h4>

<p><strong><a href="./bookcatalog?bookId=<%= book.getId() %>">Add to Cart</a> <a href="./bookcatalog">Continue
    Shopping</a></strong></p>
</body>
</html>